...
function Timeline() {
    ...
    return (
        <>
            <div className='mt-[96px] mb-[96px] w-[90%] mx-auto'>
                <h1 className='text-gray-400 text-6xl font-bold border-l-[6px] pl-8 border-[#2d664c]'>Timeline</h1>
            </div>
            <div className='flex flex-row w-[90%] mx-auto'>
                <div className='flex flex-col w-1/4 h-1/2'>
                    <div className='bg-[#2d664c] text-white text-2xl font-bold w-[80%] p-5'>
                        <h1 className='text-center'>Year</h1>
                    </div>
                    <div className='flex flex-col w-[80%] bg-[#40916C] text-white font-semibold py-5'>
