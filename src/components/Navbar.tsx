...
function Navbar() {
  ...
  const routesWithBackground = ['/', '/about', '/news', 'library', '/sponsors'];
    ...
    <div>
      ...
      <div className='lg:hidden'>
        {!toggleMenu ? (
          ...
          <div className='fixed top-0 right-0 h-screen w-3/4 z-10 bg-white text-2xl border-red-400 border-2 shadow-lg'>
            <button onClick={menuSelect} className='ml-4 mt-4'><MdClose size={24} /></button>
            <ul className='flex flex-col text-center mt-10 mx-auto'>
              <Link to='/'>
                <button className='my-2' onClick={menuSelect}>Home</button>
              </Link>
              <Link to='/about'>
                <button className='my-2' onClick={menuSelect}>About</button>
              </Link>
              <Link to='/rights-of-nature'>
                <button className='my-2' onClick={menuSelect}>Rights of Nature</button>
              </Link>
              <Link to='/timeline'>
                <button className='my-2' onClick={menuSelect}>Timeline</button>
              </Link>
              <Link to='/assemblies'>
                <button className='my-2' onClick={menuSelect}>Assemblies</button>
              </Link>
              <Link to='/news'>
                <button className='my-2' onClick={menuSelect}>News</button>
              </Link>
              <Link to='/library'>
                <button className='my-2' onClick={menuSelect}>Library</button>
              </Link>
              <Link to='/sponsors'>
                <button className='my-2' onClick={menuSelect}>Sponsors</button>
              </Link>
              <Link to='/donate'>
                <button className='my-2' onClick={menuSelect}>Donate</button>
              </Link>
            </ul>
          </div>
        )}
      ...
      {showBackground ? (
        ...
        <div className='hidden lg:flex lg:flex-row lg:flex-grow-[2]'>
          <div className='w-[300px] h-[200px] overflow-hidden'>
            ...
            <div>
              <a href='https://1oceanfund.org/' target='_blank' rel='noopener noreferrer'>
                <img className='mt-[10px] h-[90px] w-[300px] ml-[20px] py-1' alt='Affiliated Website Logo' src='/images/1ocean-logo.svg' />
              </a>
              <a href='/'>
                <img className='mt-[10px] h-[90px] w-[300px] ml-[20px] py-1' alt='Main Website Logo' src='/images/hwni-logo.svg' />
              </a>
            </div>
          </div>
          <div className='flex flex-grow-[2] h-[100px] justify-end mt-[20px] z-[2] mr-[20px]'>
            ...
            <Link to='/rights-of-nature'>
              <button className='text-black font-[450] text-[16px] h-[50px] w-[100px] mt-[5px] border-0 mr-[20px] hover:underline underline-offset-8 special-nav-font-size'>Rights Of Nature</button>
            </Link>
            <Link to='/timeline'>
