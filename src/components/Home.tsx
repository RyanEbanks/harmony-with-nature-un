  ...
  return (
    <div className='home-container'>
      ...
      <div className='flex flex-col lg:flex-row justify-center pt-10 pb-10 overflow-hidden max-w-full'>
        ...
        <div className='text-xl md:text-2xl lg:w-[80%] flex flex-col font-normal text-center md:text-left lg:my-auto mx-5 md:mx-8 pt-5 lg:pt-0 lg:px-[50px]'>
          <h1 className='ml-auto my-20 text-end text-5xl font-light border-r-8 border-[#F0910c] w-1/4 pr-4'>HARMONY WITH NATURE</h1>
      ...
      <div className='w-full lg:w-[80%] lg:mx-auto '>
        <div className='flex flex-col lg:flex-row mt-[160px] pb-5 mb-[38px]'>
          <div className='pr-8 flex flex-col lg:mr-5'>
            <h1 className='text-2xl md:text-5xl font-light mx-8 lg:mx-0 border-b-[6px] border-[#40916C] pb-2 mb-[27px] w-[85%]'>International Mother Earth Day</h1>
        ...
        <div className='flex flex-col lg:flex-row mt-[160px] pb-5 mb-20'>
          ...
          <div className='pl-8 flex flex-col lg:ml-5'>
            <h1 className='text-2xl md:text-5xl font-light mx-8 lg:mx-0 border-b-[6px] border-[#F0910c] pb-2 mb-[27px] w-[65%]'>Nature as a Global Entity</h1>
