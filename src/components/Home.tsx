...
function Home() {
  ...
  return (
    <div className='home-container'>
      ...
      <div className="home-sub-container mx-auto mt-20">
        <div className='bg-[#f6f6f7] flex flex-col lg:flex-row justify-center pt-10 pb-10 overflow-hidden max-w-full mt-10'>
          ...
          <div className='text-lg md:text-2xl flex flex-col font-normal text-center md:text-left lg:my-20 mx-5 md:mx-8 pt-5 lg:pt-0 px-5 lg:px-[50px]'>
            <img src="/images/wilderness.jpg" alt="Wilderness taken by Peter Robbins" className='w-[1260px] h-[610px] mx-auto mb-[50px]' />
            <div className='mx-auto mb-5 text-center text-3xl font-bold text-[#232420]  w-full lg:w-1/2 pr-4'>
        ...
        <div className='w-[75%] mx-auto'>
          <div className='home-content-parent-container my-40'>
            <div className="home-content-child-container flex flex-col lg:flex-row items-center">
              ...
              <div className='home-content flex-1'>
                <h1 className='mx-auto lg:mx-0 w-3/4 text-center lg:text-left text-3xl font-bold text-[#232420] border-b-[6px] border-[#40916C] pb-2 mb-[27px]'>International Mother Earth Day</h1>
                <p className='md:w-3/4 lg:w-full text-center lg:text-left text-sm md:text-lg font-normal mx-8 md:mx-auto lg:mx-0 leading-golden lg:leading-golden-lg'>In 2009, the United Nations established International Mother Earth Day to promote Harmony with Nature and address the urgent need for sustainable
          ...
          <div className='home-content-parent-container pb-40'>
            <div className="home-content-child-container flex flex-col-reverse lg:flex-row items-center">
              <div className='home-content flex-1'>
                <h1 className='mx-auto lg:mx-0 w-3/4 text-center lg:text-left text-3xl font-bold text-[#232420] border-b-[6px] border-[#F0910c] pb-2 mb-[27px]'>Nature as a Global Entity</h1>
                <p className='md:w-3/4 lg:w-full text-center lg:text-left text-sm md:text-lg font-normal mx-8 md:mx-auto lg:mx-0 leading-golden lg:leading-golden-lg'>The UN’s resolutions advocate for a non-anthropocentric relationship with Nature, respecting Earth as a living entity vital to human survival rather
