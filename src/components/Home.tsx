    ...
    <div className='home-container'>
      ...
      <div className='w-3/4 mx-auto'>
        <div className='flex flex-row mt-20 pb-5'>
          <img className='home-picture-styling' alt='United Nations Hall 2009' src='/images/UN2009.jpg'></img>
          <div className='m-5 pl-5 justify-center'>
            ...
            <button className='btn-primary home-btn-styling'>Learn More</button>
          </div>
        </div>
        <div className='flex flex-row mt-5 pb-5 mb-20'>
          ...
          <img className='home-picture-styling' alt='United Nations Hall 2009 Personnel' src='/images/UN2009-2.jpg'></img>
        </div>
      </div>
    </div>
  );
