  ...
  return (
    <div className='home-container'>
      <div className='flex flex-col lg:flex-row justify-center pt-10 pb-10 overflow-hidden max-w-full bg-[#afb482] bg-opacity-80'>
        ...
        <div className='text-xl lg:text-[1.6rem] lg:mr-[10%] flex font-normal text-center md:text-left px-5 pt-5 lg:pt-0 lg:px-[50px]'>
          <p>
      ...
      <div className='w-full lg:w-3/4 lg:mx-auto'>
        <div className='flex flex-col lg:flex-row mt-20 pb-5'>
          ...
          <div className='lg:m-5 lg:pl-5 justify-center'>
            <p className='text-xl lg:text-[1.6rem] font-extralight mx-8 lg:mx-0'>In 2009, the United Nations General Assembly designated April 22 as International Mother Earth Day, recognizing the critical need to promote Harmony with Nature.
        ...
        <div className='flex flex-col lg:flex-row mt-5 pb-5 mb-20'>
          ...
          <div className='flex flex-col lg:m-5 pr-5 justify-center'>
            <p className='text-xl lg:text-[1.6rem] font-extralight mx-8 lg:mx-0'>The UN’s resolutions encourage a new, non-anthropocentric relationship with Nature—one that respects the Earth not as a commodity, but as a
